  ...
  return (
    <div className="main-guidbox-wrapper">
      ...
      <div className={`guidbox guidbox-1 ${showGuidBox1 ? "" : "hidden"}`}>
        ...
        <p className="guidbox-message guidbox1-message">
          Select other projects from here
        </p>
        <button
          className="guidbox-btn guidbox1-btn"
          onClick={switchGuidboxHandler}
        >
          Got it
        </button>
      </div>
      ...
      <div className={`guidbox guidbox-2 ${showGuidBox2 ? "" : "hidden"}`}>
        ...
        <p className="guidbox-message guidbox2-message">
          Our contact information in here
        </p>
        <button
          className="guidbox-btn guidbox2-btn"
          onClick={closeGuidboxHandler}
        >
          Got it
        </button>
      </div>
